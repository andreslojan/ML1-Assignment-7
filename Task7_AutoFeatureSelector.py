...
player_df = pd.read_csv(r"C:\Users\Andres Lojan Yepez\Desktop\Assignments\ML-I\Assignment 7\fifa19.csv")
...
best_features = autoFeatureSelector(dataset_path=r"C:\Users\Andres Lojan Yepez\Desktop\Assignments\ML-I\Assignment 7\fifa19.csv", methods=['pearson', 'chi-square', 'rfe', 'log-reg', 'rf', 'lgbm'])
best_features
